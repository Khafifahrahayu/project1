...
@section('content')
    ...
    <div class="site-section border-bottom" data-aos="fade">
      <div class="container">
        <center>
        <div class="row justify-content-center mb-5 center">
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/gambar1.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Khafifah Rahayu</h3>
                  
                </div>
                <div class="block-38-body">
                  <p>Seorang mahasiswa di Politeknik Negeri Ketapang jurusan Teknik Informatika yang beralamat di jl Rangga Sentap  </p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3" >
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{ url('public') }} /images/gambar-3.png" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Sintiyawati</h3>
                  
                </div>
                <div class="block-38-body">
                  <p>Seorang progremmer di Politeknik Negeri Ketapang dan seorang Developer </p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{ url('public') }} /images/gambar-2.jpeg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Muhammad Amrin Mukhodas</h3>
                  
                </div>
                <div class="block-38-body">
                  <p>Seorang Developer Progremming</p>
                </div>
              </div>
            </div>
          </div>
